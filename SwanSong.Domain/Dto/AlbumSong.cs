...
public record AlbumSongUpdateRequest(long Id, long AlbumId, int? Order, int? Side, AlbumSongSongUpdateRequest Song);

public record AlbumSongResponse(long Id, long AlbumId, long SongId, SongResponse Song, int? Order, int? Side);

public record AlbumSongActionResponse(long Id, long SongId);